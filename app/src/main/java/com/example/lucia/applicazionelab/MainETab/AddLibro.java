...
public class AddLibro extends ActionBarActivity {
    ...
    //dichiarazione elementi presenti nel layout
    Button btnAdd;
    EditText Editname;
    EditText EditAutor;
    EditText EditAnn;
    ...
    //creazione reference allo storage
        ...
        btnAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!name1.isEmpty() && !autor1.isEmpty() && !gener1.isEmpty() && !code.isEmpty() && !anno1.isEmpty())
                {
                    ...
                    //ora creo un nodo libri che mi ritorna la chiave unica del libro (quella che solo questa app può avere
